...
| XML formatting | B- | Experimental coverage includes XML-family extension detection, element-only pretty-printing, comments, processing instructions, directives, CDATA fallback, mixed text fallback, and XML-family fixtures. | Add more namespace-heavy and real-world XML-family fixtures before removing the experimental label. |
