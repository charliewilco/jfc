...
| JSON and JSONL formatting | A- | Structured rendering, key sorting, fixture coverage, fuzz seeds, and semantic assertions cover real JSON-shaped data. | Keep adding real JSON and JSONL fixtures when regressions appear. |
