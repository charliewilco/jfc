...
- XML formatting is experimental. Pretty-print only structurally safe XML; preserve explicit empty tags versus self-closing tags; validate and preserve CDATA, mixed text content, multiline text elements, `xml:space="preserve"`, and multiline/tabbed attributes.
